...
#### More practice with variables and primitives: [2.2.1-JSVariablesAndPrimitives.md](Activities/2.2-Activities/2.2.1-JSVariablesAndPrimitives.md)
...
4. _null_ - If we want to indicate that a variable is "blank" **on purpose**, we _explicitly_ assign the variable a value of `null`.
...
#### More practice with primitives and template literals: [2.2.2-JSMorePrimitives.js](Activities/2.2-Activities/2.2.2-JSMorePrimitives.md)
